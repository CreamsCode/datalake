...
def main(queue_url, region_name, ip, db_name):
    ...
    try:
        try:
            # Recibir un solo mensaje de SQS
            messages = sqs_manager.receive_messages(MaxNumberOfMessages=1)
            ...
            for message in messages:
                ...
                logging.info(f"Mensaje {message['MessageId']} eliminado de la cola.")
